  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center w-[90%] mx-auto md:w-[80%]">
        <div className="left h-2/3 w-full relative flex flex-col justify-center items-center my-32">
          <div className="flex flex-col justify-center items-center text-center mt-10 mx-5">
            <PageTitle title="Projects" />
          </div>
        </div>
        <div className="right w-[80%] max-w-[90%] mx-auto grid text-center gap-20 gap-y-12 mb-10 lg:max-w-[70%] sm:grid-cols-2  xl:grid-cols-3 xl:gap-20">
          <WorkCard
            img="/Tenzies.gif"
